...
import EventPageFetchObjectItem from '../models/EventPageFetchObjectItem';

function EventPage() {
  const [eventInfo, setEventInfo] = useState<EventPageFetchObjectItem>({
    event_ID: 0,
    event_date: '',
    event_title: '',
    event_location: '',
  ...
  return (
    <div>
      ...
      <div className='flex flex-row justify-center my-5 space-x-4'>
        ...
        {id && (
          <DeleteButton eventId={id.toString()} />
        )}
      </div>
    </div>
  )
