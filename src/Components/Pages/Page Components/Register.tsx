...
export const Register = (props: RegisterAndLoginProps) => {
    ...
    return (
        <>
            <div className='container flex flex-wrap justify-center items-center m-auto w-auto'>
                <form className="w-full max-w-lg " method='POST' action='/register' onSubmit={handleSubmit}>
                    <div className='flex flex-wrap justify-center items-center -mx-3 mb-6 '>
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <label className="block tracking-wide text-black-700 text-xl font-bold mb-2" htmlFor='email'> Email </label>
            ...
            py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" value={email} onChange={(e) => setEmail(e.target.value)} type='text' placeholder="youremail@email.com" id="user_email" required />
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            <label className="block tracking-wide text-black-700 text-xl font-bold mb-2" htmlFor='password'> Password </label>
                            <input className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded 
            py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" value={password} onChange={(e) => setPassword(e.target.value)} type='password' placeholder="****" id="user_password" required />
                        ...
                        <div>
                            <button className="appearance-none block w-full bg-gray-200 text-black-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 hover:transform hover:scale-110 transition duration-300 hover:border-black" onClick={async () => handleSubmit} type='submit'> Create Account </button>
                        </div>
                    </div>
                </form>
            </div>
